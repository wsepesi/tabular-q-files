...
#note, made some changes to __init__ superclass to call global parameters for tab q, had inital problems with trying to create another __init__ in that file
